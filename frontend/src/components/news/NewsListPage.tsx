...
import BloodPlasmaBanner from '../pages/BloodPlasmaBanner';
...
const NewsListPage: React.FC = () => {
    ...
    return (
        <>
            <BloodPlasmaBanner
                title="Notizie"
                description="Resta aggiornato su tutte le attività e le novità di Avis Merate"
            />
            <div className="news-list-page" style={{ maxWidth: '1200px', margin: '0 auto 2rem auto', padding: '0 1.5rem' }}>
